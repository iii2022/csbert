...
if __name__ == "__main__":
    ...
    triple_pkl = "aligment/triples.pkl" # conceptnet triples
    name_aligment = "conceptnet.hownet/convert_aligment_HasContext_match_result.pkl" # aligment 
    aligment_pkl = "conceptnet.hownet/aligment_full_match_result_HasContext.pkl" # output
    ...
    aligment = []
    with open(name_aligment,"rb") as f:
        data_ = pickle.load(f)
        for d in tqdm(data_):
            # print(d)
            id_ = d["statement_id"]
