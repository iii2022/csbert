...
with open(relation_cur+"_neg_match_result.txt",'w',encoding='utf-8') as hownet0:
    num_i=0;
...
with open("neg1.json","r") as a:
    nid_2_triple_context=json.load(a);
num_j=0;
with open(relation_cur+"_neg_match_result_noxiaoqi.txt",'w',encoding='utf-8') as hownet0:
